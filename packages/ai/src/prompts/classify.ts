...
Schema:
{
  ...
  "reminder_at": "ISO8601 with timezone offset or null",
  "confidence": 0.0
}
...
- When "reminder_at" is present, it must include an explicit timezone offset, for example "2026-04-13T18:15:00-05:00".
- Interpret dates/times in the user's timezone from the provided context, not in UTC unless the context timezone is UTC.
...
Output: {"cleaned_text":"Call mom tomorrow at 7:00 PM.","type":"reminder","actionability":"now","entities":{"people":["mom"],"dates":["tomorrow 7pm"],"places":[],"urls":[]},"reminder_at":"2026-03-29T19:00:00-05:00","confidence":0.97}
...
Output: {"cleaned_text":"Dentist appointment on May 9 at 2:00 PM downtown.","type":"event","actionability":"now","entities":{"people":[],"dates":["May 9 2pm"],"places":["downtown"],"urls":[]},"reminder_at":"2026-05-09T14:00:00-05:00","confidence":0.96}
...
Output: {"cleaned_text":"Follow up with the recruiter Friday morning.","type":"reminder","actionability":"now","entities":{"people":["recruiter"],"dates":["Friday morning"],"places":[],"urls":[]},"reminder_at":"2026-04-03T09:00:00-05:00","confidence":0.88}
